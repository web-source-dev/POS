  ...
  useEffect(() => {
    if (open && item) {
      setFormData({
        ...
        dimensions: {
          length: item.dimensions?.length ? item.dimensions.length.toString() : "",
          width: item.dimensions?.width ? item.dimensions.width.toString() : "",
          height: item.dimensions?.height ? item.dimensions.height.toString() : ""
        },
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Edit the details for this inventory item. Navigate through tabs to update information.
          </DialogDescription>
        </DialogHeader>
