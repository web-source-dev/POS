...
// Add a type definition for Supplier
interface Supplier {
  _id: string;
  name: string;
  contact: string;
...
export function AddInventoryForm() {
  ...
  // Add supplier dialog state here with proper typing
  ...
  useEffect(() => {
    ...
    // Update the supplier loading code to load full supplier objects
    loadSuppliers();
  ...
  // Update the loadSuppliers function to use getAllSuppliers and add proper types
  const loadSuppliers = () => {
  ...
  // Update the handleSupplierAdded function with proper types
  ...
  return (
    <Card className="w-full border shadow-sm">
      <CardContent className="p-6">
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <h2 className="text-2xl font-bold tracking-tight mb-1">Add New Inventory Item</h2>
            <p className="text-muted-foreground">Fill the form below to add a new item to your inventory.</p>
          </div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="stock" className="space-y-4 mt-4 bg-muted/10 p-4 rounded-lg border">
              ...
              <div className="grid grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="reorderLevel" className="font-medium flex gap-1">
                  ...
                  <div className="relative">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent side="right">
                          <p className="max-w-xs">The stock level at which you should reorder this item</p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  </div>
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      ...
                      >
                        ...
                        {formData.expiryDate ? format(formData.expiryDate, "PPP") : "Set expiry date (optional)"}
                      </Button>
                    </PopoverTrigger>
                    <PopoverContent 
                  ...
                  <div className="relative">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent side="right">
                          <p className="max-w-xs">The price you paid for this item. Used to calculate profit margins.</p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  </div>
                    ...
                    <div className="bg-muted/20 rounded-md p-3 border">
                      ...
                      <div className="flex items-center gap-2">
                        <div className={`p-2 rounded-md ${
                          ...
                          ((Number(formData.price) - Number(formData.purchasePrice)) / Number(formData.price)) * 100 > 20
                            ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-500'
                            : Number(formData.purchasePrice) > 0 && 
                            ((Number(formData.price) - Number(formData.purchasePrice)) / Number(formData.price)) * 100 > 0
      ...
      {/* Add the supplier dialog here, inside the return statement but outside the form */}
      <AddSupplierDialog
