...
export const inventoryService = {
   ...
   */
  getItems: (filters = {}, page = 1, limit = 20) => {
  ...
  /**
   * Get all inventory items without pagination (for export and special tabs)
   */
  getAllItems: (filters = {}) => {
    const queryParams = new URLSearchParams();
    ...
    // Set a large limit to get all items (adjust this based on expected max inventory size)
